...
* Set the working directory to "Replication Package"

* Import the unified_data.csv
import delimited "stored_datasets/unified_data.csv"
save "stored_datasets/unified_data.dta", replace

* Clear the workspace
clear

* Import the structural_variables_dataset.csv
import delimited "stored_datasets/structural_variables_dataset.csv"
save "stored_datasets/structural_variables_dataset.dta", replace

* Clear the workspace
clear

* Import unified_data.dta again for merging
import delimited "stored_datasets/unified_data.csv"

* Merge with structural_variables_dataset.dta
merge 1:1 group id_spec using "stored_datasets/structural_variables_dataset.dta"
****** missing values *******
