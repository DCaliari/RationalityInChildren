...
function A = Rho_var_merletti(t, set, U_set, r)
...
elseif s==5
tot = 1-(1-r(temp(1)))*(1-r(temp(2)))*(1-r(temp(3)))*(1-r(temp(4)))*(1-r(temp(5)));
A(temp(1)) = r(temp(1))/tot;
A(temp(2)) = ((1-r(temp(1)))*r(temp(2)))/tot;
A(temp(3)) = ((1-r(temp(1)))*(1-r(temp(2)))*r(temp(3)))/tot;
A(temp(4)) = ((1-r(temp(1)))*(1-r(temp(2)))*(1-r(temp(3)))*r(temp(4)))/tot;
A(temp(5)) = ((1-r(temp(1)))*(1-r(temp(2)))*(1-r(temp(3)))*r(temp(4))*r(temp(5)))/tot;
end
