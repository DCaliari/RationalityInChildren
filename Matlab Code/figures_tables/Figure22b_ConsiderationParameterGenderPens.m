...
T1st5thGrade_G_pens = (P1pp(1)-P1pp(5))/sqrt(S1pp(1)^2 + S1pp(5)^2);
T1st5thGrade_B_pens = (P2pp(1)-P2pp(5))/sqrt(S2pp(1)^2 + S2pp(5)^2);


% T-test acroos schools at grade 1st, 5th, and total pens
TacrossGender_1st_pens = (P1pp(1)-P2pp(1))/sqrt(S1pp(1)^2 + S2pp(1)^2);
TacrossGender_5th_pens = (P1pp(5)-P2pp(5))/sqrt(S1pp(5)^2 + S2pp(5)^2);
TacrossGender_Tot_pens = (P1pp(6)-P2pp(6))/sqrt(S1pp(6)^2 + S2pp(6)^2);
...
TacrossGender_1st_pens;
TacrossGender_5th_pens;
TacrossGender_Tot_pens];

Pvalue = normcdf(TT)*2; % two-tailed p-value

% Saving tables summarizing the t-tests and the comparisons

section_A1OA_11 = array2table([[P1pp(1);P2pp(1)], [P1pp(5);P2pp(5)], Pvalue(1:2)] , ...
    "RowNames", {'Pens - Female', 'Pens - Male'}, "VariableNames",{'1st','5th','pvalue'})

section_A1OA_21 = array2table([[P1pp(1);P1pp(5);P1pp(6)], [P2pp(1);P2pp(5);P2pp(6)], Pvalue(3:end)], ...
    "RowNames", {'Pens - 1st', 'Pens - 5th', 'Pens - aggregate'}, "VariableNames",{'Female','Male','pvalue'})
