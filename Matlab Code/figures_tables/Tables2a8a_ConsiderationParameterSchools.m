...
SchoolLPencils = RHO{1,1}([1:5 11], 1);
SchoolLPens = RHO{1,2}([1:5 11], 1);
SchoolHPencils = RHO{1,1}([6:10 12], 1);
SchoolHPens = RHO{1,2}([6:10 12], 1);

TABLEschools = array2table([SchoolLPencils,SchoolLPens,SchoolHPencils,SchoolHPens], "RowNames",{'1st','2nd','3rd','4th','5th','Aggregate'},"VariableNames",{'School L - pencils', 'School L - pens', 'School H - pencils', 'School H - pens'});

clearvars -except TABLEschools SchoolLPencils SchoolLPens SchoolHPencils SchoolHPens
