...
section_5_2_1 = array2table([[P1p(1);P2p(1)], [P1p(5);P2p(5)], Pvalue(1:2)] , ...
    "RowNames", {'Pencils - School L', 'Pencils - School H'}, "VariableNames",{'1st','5th','pvalue'})

section_5_2_2 = array2table([[P1p(1);P1p(5);P1p(6)], [P2p(1);P2p(5);P2p(6)], Pvalue(3:end)], ...
    "RowNames", {'Pencils - 1st', 'Pencils - 5th', 'Pencils - aggregate'}, "VariableNames",{'School L','School H','pvalue'})
