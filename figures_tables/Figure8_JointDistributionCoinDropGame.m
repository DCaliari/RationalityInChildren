...
%% Load key variables
create_variables          % Function to create necessary variables
create_pachinko_dataset   % Function to create pachinko dataset
...
%%% Create a dummy variable for attrition
...
win = (threes_twos == 1 & esito < 5 & esito > 0) | ...
      ...
      (twos_ones == 1 & esito < 8 & esito > 0); % Logical conditions for winning
win = double(win);                % Convert to double for further analysis
win(esito == 0) = 99;            % Assign a value for undefined cases

%% Correlation between the two waves
newdata = covered & ~attrition;  % Logical array indicating valid data points
...
% Create logical fail_corr variable indicating correction failure
...
E = school_pachinko > 1 & school_pachinko < 4; % Other categories
